...
fvctl -n add-flowspace dpid1_port1 1 1 in_port=1 Regular=7
fvctl -n add-flowspace dpid1_port2 1 1 in_port=2 LoRa=7

fvctl -n add-flowspace dpid1_port3-LoRa 1 10 in_port=3,nw_src=10.0.0.1 LoRa=7
fvctl -n add-flowspace dpid1_port3-Regular 1 1 in_port=3 Regular=7

fvctl -n add-flowspace dpid1_port4-LoRa 1 10 in_port=4,nw_src=10.0.0.1 LoRa=7
...
fvctl -n add-flowspace dpid4_port4-LoRa 4 10 in_port=4,nw_src=10.0.0.3 LoRa=7
