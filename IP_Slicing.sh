...
fvctl -n add-flowspace dpid1_ARP 1 300 dl_type=0x0806 Regular=6
...
fvctl -n add-flowspace dpid1_port2_ARP 1 300 in_port=2,dl_type=0x0806 DevNull=6
...
fvctl -n add-flowspace dpid3_ARP 1 300 dl_type=0x0806 DevNull=6
fvctl -n add-flowspace dpid3_drop 3 1 any DevNull=2


# Add flowspaces for switch 4.
fvctl -n add-flowspace dpid4_ARP 1 300 dl_type=0x0806 Regular=6
