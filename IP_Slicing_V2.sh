...
fvctl -n add-flowspace dpid1_LoRa_out 1 100 nw_src=10.0.0.1,nw_dst=10.0.0.3 LoRa=7
fvctl -n add-flowspace dpid1_LoRa_in 1 100 nw_src=10.0.0.3,nw_dst=10.0.0.1 LoRa=7
...
fvctl -n add-flowspace dpid4_LoRa_in 4 100 nw_src=10.0.0.1,nw_dst=10.0.0.3 LoRa=7
fvctl -n add-flowspace dpid4_LoRa_out 4 100 nw_src=10.0.0.3,nw_dst=10.0.0.1 LoRa=7
