...
fvctl -n add-flowspace dpid1_port3-video 1 100 in_port=3,tp_src=9999 video=7  # Priority 100.
fvctl -n add-flowspace dpid1_port3-video 1 100 in_port=3,tp_dst=9999 video=7
fvctl -n add-flowspace dpid1_port3-non-video 1 1 in_port=3 non-video=7
fvctl -n add-flowspace dpid1_port4-video 1 100 in_port=4,tp_src=9999 video=7
fvctl -n add-flowspace dpid1_port4-video 1 100 in_port=4,tp_dst=9999 video=7
...
fvctl -n add-flowspace dpid4_port3-video 4 100 in_port=3,tp_src=9999 video=7  # Priority 100.
fvctl -n add-flowspace dpid4_port3-video 4 100 in_port=3,tp_dst=9999 video=7
fvctl -n add-flowspace dpid4_port3-non-video 4 1 in_port=3 non-video=7
fvctl -n add-flowspace dpid4_port4-video 4 100 in_port=4,tp_src=9999 video=7
fvctl -n add-flowspace dpid4_port4-video 4 100 in_port=4,tp_dst=9999 video=7
