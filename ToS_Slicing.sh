...
fvctl -n add-flowspace dpid1_port4-LoRa 1 100 in_port=4,nw_tos=8 LoRa=7
fvctl -n add-flowspace dpid1_port4-Normal 1 1 in_port=4 Normal=7  # Priority 1.
...
fvctl -n add-flowspace dpid4_port3-LoRa 4 100 in_port=3,nw_tos=8 LoRa=7  # Priority 100.
